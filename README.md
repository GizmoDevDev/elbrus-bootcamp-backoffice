...
Исходя из текущей диаграммы можно ожидать, что если выделить 4 программистов на этот проект, из которых 2 мидла и 2 джана, то можно ожидать сокращение временных затрат на задачи.
Как итог первую версию можно реализовать в течение одного спринта.
...
Как итог может вырасти цена на реализацию следующих версий, которых запланировано две
